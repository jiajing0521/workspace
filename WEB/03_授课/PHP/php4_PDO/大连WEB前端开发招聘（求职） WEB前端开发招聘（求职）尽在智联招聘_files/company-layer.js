$(document).ready(function () {
    ...
    /*var offsetY = $(window).height() - $('#div_01').height() + $(document).scrollTop();
    $('#div_01').css({ 'top': offsetY });*/
    ...
    if (removeCompsStr != null && removeCompsStr != "") {
        ...
        $(".alt_close02").each(function () {
            ...
            jqThisDom.bind("click", function () {
                ...
                jqNumRemoveCom.html(jqNumRemoveCom.html() * 1 - 1);
                jqThisDom.parent().parent(".dsp_none").hide();*/
            });
        });
    }
    var jqNumRemoveCom = $("#remove_com_num");
