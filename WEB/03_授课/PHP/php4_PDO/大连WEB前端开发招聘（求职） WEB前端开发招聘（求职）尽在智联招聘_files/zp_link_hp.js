(function(){
    try{
        var _domain_ = document.domain,
            _cookie_ = getCookie('JSpUserInfo') || getCookie('JSsUserInfo'),
            _cookie_param_ = (_cookie_ ? 'cku=' + _cookie_ : ''),
            _hp_url = '',
            $hpLink = null,
            $logoutBtn = null,
            logoutBtn = null;
                ...
                if(typeof $ === 'function'){
                    ...
                    if($logoutBtn.length>0){
                        ...
                        logoutBtn.onclick= function(){
                            _hp_url  = $hpLink.attr('href');
                            if(_hp_url.indexOf('cku=')!=-1){
                                $hpLink.attr('href',_hp_url.substring(0,_hp_url.indexOf('cku=')-1));
                            }
                        };
                    }
                }
